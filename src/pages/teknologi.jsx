  ...
  const news = [
    {
      ...
      excerpt: "Apple memperkenalkan teknologi AI yang terintegrasi dalam semua perangkat barunya...",
    ...
    },
    {
      ...
      excerpt: "Startup teknologi asal Indonesia mencuri perhatian di ajang CES tahun ini...",
    ...
    },
    {
      ...
      excerpt: "AI generatif terus mengubah cara kita bekerja, berkreasi, dan berinteraksi...",
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="space-y-4 mb-8">
        ...
        >
          Berita Teknologi Dunia
        </motion.h1>
        <p className="text-lg text-gray-600">
          Perkembangan terbaru dari dunia teknologi, gadget, AI, dan inovasi digital global.
        </p>
      </div>

      {/* Filter and Sort + Trending Tags */}
